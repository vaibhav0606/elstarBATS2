...
export const SPLITTED_SIDE_NAV_MINI_WIDTH = 100
export const SPLITTED_SIDE_NAV_SECONDARY_WIDTH = 200
export const SIDE_NAV_CONTENT_GUTTER = 'px-4'
export const LOGO_X_GUTTER = 'px-6'
export const HEADER_HEIGHT_CLASS = 'h-16'
export const PAGE_CONTAINER_GUTTER_X = 'px-2 sm:px-6 md:px-6'
export const PAGE_CONTAINER_GUTTER_Y = 'py-2 sm:py-6 md:px-6'
