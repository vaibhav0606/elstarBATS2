...
function SeasonMapping() {
    const columns = useMemo(
        () => [
            { header: 'Seasonno', accessorKey: 'Seasonno' },
            { header: 'StartEpisodes', accessorKey: 'StartEpisodes' },
            { header: 'EndEpisodes', accessorKey: 'EndEpisodes' },
        ],
        []
    )
    const data10 = [{ Seasonno: '', StartEpisodes: '', EndEpisodes: '' }]
